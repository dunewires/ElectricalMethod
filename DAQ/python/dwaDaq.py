...
class MainWindow(qtw.QMainWindow):
    ...
    def resFreqRunFit(self):
        ...
        for chan in self.activeRegistersS:
            ...
            # Only include peaks that are fit well buy a decaying sin finction
            peakFreqsFit = []
            for peakFreq in peakFreqs:
                r2 = resonance_fitter.get_r2(self.ampDataS[reg]['freq'], self.ampDataS[reg]['ampl'], peakFreq)
                # The peak tends to be happen about 2Hz after the start of the resonance
                if r2 > 0.7: peakFreqsFit.append(peakFreq-2)
            ...
            self.resonantFreqs[chan] = peakFreqsFit[:]
