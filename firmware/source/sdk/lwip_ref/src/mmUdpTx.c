...
int drainDebugFifoUdp(int fifoAddr) {
  ...
  rDFifoTxIndex = 8;
  //regStatusInitial = *(u32_t *) (XPAR_PLAXI_INTERFACE_0_S00_AXI_BASEADDR + (0x0005 << 2));
  //regStatusNext = *(u32_t *) (XPAR_PLAXI_INTERFACE_0_S00_AXI_BASEADDR + (0x0003 << 2));
  ...
  while (1) {
	...
	if (rDFifoTxIndex > 8)
	  {
	    statusFlags = *(unsigned int *) (XPAR_PLAXI_INTERFACE_0_S00_AXI_BASEADDR + (0x0001 << 2));
