...
HD_PWD='/home/nate/projects/duneWireTension/vivadoProjects/dwa_ps/dwa_ps.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dwa_ps_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dwa_ps_bd_wrapper.tcl
