...
read_vhdl -library xil_defaultlib /home/nate/projects/duneWireTension/vivadoProjects/dwa_ps/dwa_ps.srcs/sources_1/imports/hdl/dwa_ps_bd_wrapper.vhd
...
synth_design -top dwa_ps_bd_wrapper -part xc7z020clg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef dwa_ps_bd_wrapper.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file dwa_ps_bd_wrapper_utilization_synth.rpt -pb dwa_ps_bd_wrapper_utilization_synth.pb"
