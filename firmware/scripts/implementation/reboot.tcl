...
connect_hw_server -url localhost:3121 -allow_non_jtag
 ...
 ## specify cable when there is more than one connected 
...
catch {boot_hw_device  [lindex [get_hw_devices xc7z020_1] 0] -disable_done_check -timeout 5 }
close_hw_target
close_hw_manager
