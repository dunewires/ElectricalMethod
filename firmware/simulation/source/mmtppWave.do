...
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/writeDone
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/writeBusy_d
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/writeBusy
...
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/snInitRead
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/shiftReg
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/serString
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/serialCmdEnable
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/serialAddress
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/sendStop
...
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/readDone
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/readBusy_d
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/readBusy
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/nWord
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/nRxWord
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/memWrite
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/memRead
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/memAddr
...
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/deviceAddr
...
add wave -noupdate -expand -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/clkCnt
...
update
WaveRestoreZoom {380325880167 fs} {727352322097 fs}
