...
add wave -noupdate -group {serial PROM} /tb_adc_emu/top_tension_analyzer_1/serialPromInterface_inst/shiftReg
...
update
WaveRestoreZoom {144844878288 fs} {1515257022837 fs}
